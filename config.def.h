...
static const char *fonts[] = {"Iosevka Nerd Font Mono:size=13",
                              "monospace:size=13"}; // main and fallback font

// colorscheme
// #define MAOMAO_ENABLED
#ifdef MAOMAO_ENABLED
#define col_1 "#cf8592"
#define col_2 "#165a5d"
#define col_3 "#eab8bb"
#define col_4 "#298657"
...
#define GRUBER_DARKER_ENABLED
#ifdef GRUBER_DARKER_ENABLED
#define col_1 "#ffdd33"
#define col_2 "#282828"
#define col_3 "#e4e4e4"
#define col_4 "#95a99f"
...
static const char *volumeupcmd[] = {"pulsemixer", "--change-volume", "+5",
                                    NULL};
static const char *volumedowncmd[] = {"pulsemixer", "--change-volume", "-5",
                                      NULL};
